...
global userNodesList, timelinesNodesList
...
#In this method we call the authenticateUser(username, password) from the app.py to validate the user credentials
def check_credentials(username, password):
    data = {'username': username, 'password': password }
    url = next(userNodes) + '/login'
...
def route_page(err):
    ...
    #This logic helps in redirecting the requests to the correct instances of each microservice
